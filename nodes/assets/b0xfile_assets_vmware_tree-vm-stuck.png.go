// Code generaTed by fileb0x at "2024-04-08 14:11:58.898552 -0500 CDT m=+0.701284834" from config file "b0x.yml" DO NOT EDIT.
// modified(2011-12-13 11:18:46 -0600 CST)
// original path: ../../assets/vmware/tree-vm-stuck.png
...
func init() {
	...
	f, err := FS.OpenFile(CTX, "assets/vmware/tree-vm-stuck.png", os.O_RDWR|os.O_CREATE|os.O_TRUNC, 0777)
	if err != nil {
		panic(err)
	}
